...
#endif
	typedef __Request__exception_raise_t __Request;
	typedef __Reply__exception_raise_t Reply __attribute__((unused));
...
mig_internal kern_return_t __MIG_check__Request__exception_raise_state_t(__attribute__((__unused__)) __Request__exception_raise_state_t *In0P, __attribute__((__unused__)) __Request__exception_raise_state_t **In1PP)
{
	...
	msgh_size = In0P->Head.msgh_size;
	if ((In0P->Head.msgh_bits & MACH_MSGH_BITS_COMPLEX) ||
	    (msgh_size < (mach_msg_size_t)(sizeof(__Request) - 2464)) ||  (msgh_size > (mach_msg_size_t)sizeof(__Request)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
	...
	if ( In0P->codeCnt > 2 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 2464)) / 4 < In0P->codeCnt) ||
	    (msgh_size < (mach_msg_size_t)(sizeof(__Request) - 2464) + (4 * In0P->codeCnt)))
		return MIG_BAD_ARGUMENTS;
	...
	*In1PP = In1P = (__Request *) ((pointer_t) In0P + msgh_size_delta - 8);
	...
	if ( In1P->old_stateCnt > 614 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 2464)) / 4 < In1P->old_stateCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 2464) + (4 * In1P->old_stateCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
...
#endif
	typedef __Request__exception_raise_state_t __Request;
	typedef __Reply__exception_raise_state_t Reply __attribute__((unused));
...
#endif
	typedef __Request__exception_raise_state_identity_t __Request;
	typedef __Reply__exception_raise_state_identity_t Reply __attribute__((unused));
...
const struct catch_exc_subsystem catch_exc_subsystem = {
	exc_server_routine,
	2401,
	2404,
