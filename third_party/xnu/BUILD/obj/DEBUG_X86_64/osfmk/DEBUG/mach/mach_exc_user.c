...
#pragma pack(pop)
	...
	union mach_exception_raise_stateMessU {
		Request In;
		Reply Out;
	} *Mess = (union mach_exception_raise_stateMessU *) mig_user_allocate(sizeof(*Mess));
...
#pragma pack(pop)
	...
	union mach_exception_raise_state_identityMessU {
		Request In;
		Reply Out;
	} *Mess = (union mach_exception_raise_state_identityMessU *) mig_user_allocate(sizeof(*Mess));
