...
#endif	/* mig_external */
MIG_SERVER_ROUTINE
kern_return_t default_pager_memory_object_create
(
...
extern const struct default_pager_memory_object_default_subsystem {
	...
	struct routine_descriptor	/*Array of routine descriptors */
		routine[1];
} default_pager_memory_object_default_subsystem;
...
#ifndef __RequestUnion__default_pager_memory_object_default_subsystem__defined
#define __RequestUnion__default_pager_memory_object_default_subsystem__defined
union __RequestUnion__default_pager_memory_object_default_subsystem {
	__Request__memory_object_create_t Request_memory_object_create;
};
#endif /* __RequestUnion__default_pager_memory_object_default_subsystem__defined */
...
#ifndef __ReplyUnion__default_pager_memory_object_default_subsystem__defined
#define __ReplyUnion__default_pager_memory_object_default_subsystem__defined
union __ReplyUnion__default_pager_memory_object_default_subsystem {
	__Reply__memory_object_create_t Reply_memory_object_create;
};
#endif /* __ReplyUnion__default_pager_memory_object_default_subsystem__defined */
