...
kd_event_t kd_events[] = {
        ...
        {0x40c0448, "BSC_sys_sysctlbyname"},
        ...
        {0x40c0848, "BSC_kqueue_workloop_ctl"},
        {0x40c084c, "BSC_mach_bridge_remote_time"},
        {0x40c0850, "BSC_coalition_ledger"},
        {0x40c0854, "BSC_log_data"},
        {0x40c0858, "BSC_memorystatus_available_memory"},
        ...
        {0x531029c, "CPUPM_MID"},
        {0x53102a0, "CPUPM_PST_LOAD_CAPTURE"},
        {0x53102a4, "CPUPM_PSTATE_HWP_MODE"},
        {0x53102a8, "CPUPM_PST_WR_REASON"},
        {0x5330000, "HIBERNATE"},
