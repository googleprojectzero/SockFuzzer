...
#define	host_notify_reply_MSG_COUNT	2
...
extern
#endif	/* mig_external */
kern_return_t host_calendar_set
(
	mach_port_t notify_port
);
...
#pragma pack(push, 4)
	...
	} __Request__host_calendar_changed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __Request__host_calendar_set_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __RequestUnion__host_notify_reply_subsystem {
	...
	__Request__host_calendar_set_t Request_host_calendar_set;
};
...
#pragma pack(push, 4)
	...
	} __Reply__host_calendar_changed_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		kern_return_t RetCode;
	} __Reply__host_calendar_set_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __ReplyUnion__host_notify_reply_subsystem {
	...
	__Reply__host_calendar_set_t Reply_host_calendar_set;
};
#endif /* !__RequestUnion__host_notify_reply_subsystem__defined */
